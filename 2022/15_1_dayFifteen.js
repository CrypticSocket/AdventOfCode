...
function start() {
    ...
    let lineForPositions = 2000000
    let eligiblePairs = getEligiblePairs(data, lineForPositions)
    // console.log(eligiblePairs)
    let nonBeaconPositions = getNonBeaconPositions(eligiblePairs, lineForPositions)
...
function getNonBeaconPositions(eligiblePairs, lineForPositions)
{
    ...
    let numberOfPoints = findNumberOfPoints(nonBeaconPoints)
    return numberOfPoints - beaconsPresent.size
}

function findNumberOfPoints(ranges) {
