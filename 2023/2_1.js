...
var findImpossibleGames = function(data)
{
    ...
    for(let game of data)
    {
        ...
        if(isGamePossible(cubeData))
        {
            impossibleGames.push(parseInt(gameNumber))
        }
    }
    let sumOfGameNumbers = impossibleGames.reduce((a,b) => a+b)
    return sumOfGameNumbers
}

var isGamePossible = function(cubeData)
{
